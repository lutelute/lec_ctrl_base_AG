...
福井大学 工学部 電気電子情報工学科 3年次向け講義「制御理論基礎」の教材リポジトリです。

## 講義概要

現代の制御工学における基本的な理論と手法を学びます。モデリングから解析、設計、実装に至るまで、インタラクティブなシミュレータや演習を交えながら体系的に理解を深めます。

- **対象**: 工学部 電気電子情報工学科 3年次・4年次
- **単位数**: 2単位
- **開講学期**: 前期
- **担当教員**: 重信 颯人
...
1. **制御系の基本概念を理解・説明できる**
   ...
   - 制御対象・コントローラ・センサ・アクチュエータの役割

2. **数学的手法を用いてシステムを表現・解析できる**
   - 複素数、ラプラス変換の概念と計算
   - 状態空間表現による表現と解析

3. **伝達関数や周波数応答に基づく解析ができる**
   - 伝達関数の導出と極・零点の解釈
   - ボード線図・ナイキスト線図による安定性評価

4. **制御器の設計ができる（PID・根軌跡法など）**
   - 制御器の構造と各ゲインの意味
   - 根軌跡を用いたゲイン調整と応答改善
...
- 担当教員: 重信 颯人
- E-mail: lute@u-fukui.ac.jp
- 研究室: 電力システム研究室 (1-2259)
